...
void main( void )
{
  ...
  if (gl_FragCoord.x > FrameW / 2 && gl_FragCoord.y > FrameH / 2)
    OutColor = vec4(1 - RealC.r, 1 - RealC.g, 1 - RealC.b, 1);
  else
    OutColor = RealC;
}